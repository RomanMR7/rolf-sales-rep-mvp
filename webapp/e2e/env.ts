...
export const composeProjectName =
  process.env.COMPOSE_PROJECT_NAME ?? `rolf-sales-rep-mvp-${repositoryHash}`
...
export const defaultDatabaseUrl = `postgresql://superuser:superpassword@localhost:${defaultPostgresTestPort}/rolf_sales_rep_mvp_test?schema=public`
