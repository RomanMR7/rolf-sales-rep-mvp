...
const typographyVariants = cva("min-w-0 tracking-normal", {
  variants: {
    variant: {
      h1: "font-heading text-[2rem] leading-tight font-bold md:text-4xl",
      h2: "font-heading text-[1.75rem] leading-tight font-bold md:text-[2rem]",
      h3: "font-heading text-2xl leading-snug font-bold",
      h4: "font-heading text-xl leading-snug font-semibold",
      h5: "font-heading text-lg leading-snug font-semibold",
      h6: "font-heading text-base leading-snug font-semibold",
