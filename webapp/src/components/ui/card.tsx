...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card rolf-panel flex flex-col gap-6 rounded-2xl py-6 text-card-foreground ring-1 ring-white/5 backdrop-blur has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-2xl *:[img:last-child]:rounded-b-2xl",
        className
      )}
      {...props}
    />
