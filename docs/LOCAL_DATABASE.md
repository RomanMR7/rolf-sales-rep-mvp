...
docker compose exec postgres pg_isready -U superuser -d rolf_sales_rep_mvp
```
...
host: localhost
port: 54329
database: rolf_sales_rep_mvp
user: superuser
password: superpassword
DATABASE_URL: postgresql://superuser:superpassword@localhost:54329/rolf_sales_rep_mvp?schema=public
```
...
host: localhost
port: 54330
database: rolf_sales_rep_mvp_test
user: superuser
password: superpassword
